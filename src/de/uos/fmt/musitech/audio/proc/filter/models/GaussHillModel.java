...
import de.uos.fmt.musitech.audio.proc.filter.Coefficients;
 ...
 */
public class GaussHillModel extends DLFModel {

	private Vector gaussHills = new Vector();

	public GaussHillModel (Coefficients coefficients){
...
//			GaussHill g = (GaussHill) it.next();
//			add(g);
//		}
	}
	
//	private void add(GaussHill g){
