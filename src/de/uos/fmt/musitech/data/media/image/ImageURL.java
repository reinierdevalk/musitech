...
/**
 * A wrapper for a URL to an image.
 * 
 * @author Tillman Weyde
 *  
 * @hibernate.class table = "ImageURL"
 * 
 */
public class ImageURL implements MObject {
    URL sourceUrl;
	...
	public ImageURL(String urlString) throws MalformedURLException{
	...
	/**
	 * @param url the new Source of this image
	 */
	...
	public void setFile(File file) throws MalformedURLException{
			sourceUrl = file.toURL();
	}

	public void setFile(String filename) throws MalformedURLException{
			setFile(new File(filename));
	}

	public void setSourceUrl(String urlString) throws MalformedURLException{
			setSourceUrl(new URL(urlString));
	}
