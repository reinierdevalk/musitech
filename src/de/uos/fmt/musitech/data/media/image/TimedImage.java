...
/**
 * To have an Image with an timestamp
 * used to show Images at this time
 * used in ImageSequenceContainer
 * @author Jan
 * 
 * @hibernate.class table = "TimedImage"
 * @hibernate.joined-subclass
 * @hibernate.joined-subclass-key  column = "uid"
 * 
 * 
 */
public class TimedImage extends ImageURL implements Timed {
	...
	public TimedImage(URL url){
		setSourceUrl(url);
	}

	public TimedImage(URL url, long time){
		this(url);
		setTime(time);
	}
