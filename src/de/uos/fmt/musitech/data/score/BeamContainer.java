...
/**
 * This class is used to contain NotationChords which belong to one beam.
 * It is used inside @see NotationVoice
 * @author collin
 * @version 1.0
 * @see NotationChord
 * 
 * @hibernate.class table = "BeamContainer"
 * @hibernate.joined-subclass
 * @hibernate.joined-subclass-key  column = "uid"
 * 
 */
public class BeamContainer extends SortedContainer<Note> {

//	RenderingHints renderingHints;
	/**
	 * This constructor calls the super constrcutor. It makes sure that only NotationChords are
	 * allowed inside of this container. The Comparator used is the @see MetricalComparator.
	 */
	public BeamContainer(Context context) {
		super(context, Note.class, new MetricalComparator());
	}
	
	
	public BeamContainer(Context context, Collection chords) {
		this(context);
		addAll(chords);
	}
	/**
