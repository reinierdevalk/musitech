 ...
 *
 */
public class DynamicsMarker implements Marker {
	 ...
	 * @see de.uos.fmt.musitech.data.time.Metrical#getMetricDuration()
	 */
	public void setMetricDuration(Rational dur) {
		end = start.add(dur);
	}
	...
	public void setCrescendo(boolean crescendo) {
		this.crescendo = crescendo;
	}
	public Rational getEnd() {
		return end;
	}
	public void setEnd(Rational end) {
		this.end = end;
	}
//	public Rational getStart() {
//		return start;
//	}
//	public void setStart(Rational start) {
//		this.start = start;
//	}
	public void setMetricTime(Rational newStart) {
	    if(end != null){
	        end.add(newStart.sub(start));
	    }
	    this.start = newStart;
	}
