...
/**
 * This class represents a linebreak in a system. Linebreaks have a metricTime where they happen.
 * @author collin
 * 
 */
public class Linebreak implements Metrical, Containable {
	private Rational metricTime;
	
	public Linebreak(Rational metricTime) {
