...
/**
 * This is sort of a tagging class. The only information which is added to music.Note
 * is that the note should be colored.
 * @author collin
 * 
 * @hibernate.class table="RenderingNote"
 * 
 * @hibernate.joined-subclass
 * @hibernate.joined-subclass-key  column = "uid"
 * 
 */
public class RenderingNote extends Note implements Colored, RenderingSupported {
	private Color color;
	...
	public RenderingNote(ScoreNote sn, PerformanceNote pn, Color color) {
		super(sn, pn);
		this.color = color;
	}
	
	public RenderingNote(Note n, Color color) {
		super(n.getScoreNote(), n.getPerformanceNote());
		this.color = color;
	}
