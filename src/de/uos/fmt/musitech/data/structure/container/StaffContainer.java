...
/**
 * This is a collection of elements which all belong to the same staff.
 * @author collin
 *
 */
public class StaffContainer<T extends Containable> extends BasicContainer<T> {
	private ClefContainer clefTrack;

	public StaffContainer() {
		super(Context.getDefaultContext());
	}

	public StaffContainer(Context context) {
		super(context);
	}
