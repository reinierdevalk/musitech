...
/**
 * This class represents a chord as a map between its named components 
 * and the component notes in semitones from the root. 
 * 
...
public class ChordMap {
    ...
    /**
     * Stores a string name component, e.g. "3" with a chromatic distance (in semitones) from the root. 
     * @param chordElem The string name.
     * @param chromatic The number in semitones from the root. 
     */
    public void put(String chordElem, int chromatic) {
        map.put(chordElem,chromatic);
    }
