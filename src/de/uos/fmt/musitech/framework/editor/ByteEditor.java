...
/**
 * Editor for editing properties of type "byte".
 * @author Tobias Widdra
 */
public class ByteEditor extends SimpleTextfieldEditor {

	/**
	 * Applies actual text within the textfield to <code>propertyValue</code>.
	 * <br> Shows an error dialog if the traversal from String to byte was unsuccessfull.
	 * @return true if the input is accepted
	 */
//	public boolean applyChangesToPropertyValue() {
//		try {
//			propertyValue = Byte.valueOf(textfield.getText());
//			return true;
...
//	}
	...
	/** 
	 * Returns a Byte object representing the user's input.
	 * If not Byte object could be created from the input, null is returned.
	 * 
	...
	protected Object getInputValue() {
		...
		try {
			inputValue = Byte.valueOf(textfield.getText());
		} catch(NumberFormatException e) {
			e.printStackTrace();
		}
		return inputValue;
