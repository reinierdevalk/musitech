...
/**
 * A Display for displaying Collections.
 * Uses Displays for displaying the properties and elements of the
 * Collection to display.
 * 
 * @author Kerstin Neubarth
 *  
 */
public class CollectionDisplay extends AbstractComplexDisplay {

    /**
     * Collection to be displayed.
     * May be the <code>editObj</code> or one of its properties.
     */
    Collection collection;
    
    /**
     * Collection to take the displays used for displaying the collection's elements.
     */
    private Collection elementDisplays = new ArrayList();
...
//                throw new EditorConstructionException("In CollectionDisplay: Neither the editObj nor the propertyValue is of type Collection.");
    ...
    /**
     * Creates Displays for the elements of the <code>collection</code> and adds
     * them to the <code>elementDisplays</code>. 
     * The Collection <code>elementDisplays</code> is cleared before.
     */
