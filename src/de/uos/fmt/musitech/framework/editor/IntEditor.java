...
/**
 * Editor for editing properties of type "int".
...
SimpleTextfieldEditor 
{
	 ...
	 * <br> Shows an error dialog if the traverasl from String to int was unsuccessfull.
	 * @return true if the input is accepted
	 */
//	public boolean applyChangesToPropertyValue() {
//		try {
//			propertyValue = Integer.valueOf(textfield.getText());
//			return true;
...
//	}
	...
	/** 
	 * Returns an Integer object representing the user's input.
	 * If no Integer could be created from the input, null is returned.
	 * 
	...
	protected Object getInputValue() {
		...
		try {
			inputValue = Integer.valueOf(textfield.getText());
		} catch(NumberFormatException e) {
			e.printStackTrace();
		}
		return inputValue;
