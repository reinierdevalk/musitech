...
/**
 * Editor for editing properties of type "long".
 * @author Tobias Widdra
 */
public class LongEditor extends 
...
SimpleTextfieldEditor 
{
	 ...
	 * <br> Shows an error dialog if the traversal from String to long was unsuccessfull.
	 * @return true if the input is accepted
	 */
//	public boolean applyChangesToPropertyValue() {
//		try {
//			propertyValue = Long.valueOf(textfield.getText());
//			return true;
...
//	}
	 ...
	 * If no Long could be created from the input, null is returned.
	 * 
