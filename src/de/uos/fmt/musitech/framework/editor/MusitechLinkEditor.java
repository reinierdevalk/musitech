 ...
 *
 */
public class MusitechLinkEditor extends PreviewEditor {
	...
	protected String getPreviewText() {
		...
		buffer.append(super.getPreviewText());
	...
	protected Object getObjectForEditor() {
		...
		if (editObj != null && propertyName != null) {
			if (propertyValue == null)
				setPropertyValue();
			objToEdit = propertyValue;
		}
		if (objToEdit instanceof Long){
		    PersistenceManager pm = PersistenceFactory.getDefaultPersistenceManager();
		    try {
                MObject obj = pm.read((Long)objToEdit);
                return obj;
