...
/**
 * JApplet with an Editor showing the "whole" Object.
 * 
 * @author Kerstin Neubarth
 *
 */
public class PropertyNameApplet1 extends JApplet {
    ...
    /**
     * Returns an Object to be edited. A KeyMarker is returned.
     * 
     * @return Object to be edited
     */
    private Object createEditObj(){
        KeyMarker key = new KeyMarker();
        key.setRoot('g');
        key.setRootAccidental(0);
        key.setAccidentalNum(1);
//        key.setMode(KeyMarker.MODE_MAJOR);
        return key;
    }
    
    /**
     * Returns an Editor editing the specified Object.
     * 
     * @param editObj Object to be edited
     * @return Editor editing the Object
     */
    private Editor createForWholeObj(Object editObj){
        EditingProfile profile = EditorFactory.getOrCreateProfile(editObj);
        profile.setPropertyName(null);
        Editor editor = null;
        try {
    ...
    private void createGUI(){
        Object editObj = createEditObj();
        Editor editor = createForWholeObj(editObj);
        if (editor!=null){
