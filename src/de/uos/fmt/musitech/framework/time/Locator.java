...
/**
 * Locators are used to add them as time marks in playTimer
 * 
 * 
 * @author Jan-H. Kramer
 *
 * 
 */
public class Locator implements Containable{
     ...
     * 
     */
    public Locator(long time) {
        this(time, "");
    }
    
    public Locator(long time, String name){
        setTimeInMicros(time);
        setName(name);
    }

    /**
     * @return Returns the timeInMicros.
     */
    public long getTimeInMicros() {
        return timeInMicros;
    }
    /**
     * @param timeInMicros The timeInMicros to set.
     */
    public void setTimeInMicros(long timeInMicros) {
        if (timeInMicros < 0){
