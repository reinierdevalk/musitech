...
/**
 * This Interface should be implemented by all players which uses the PlayTimer
 * to get TimePosition
 * 
 * @author Jan
 *  
 */
public interface Player extends Timeable {
    ...
    /**
     * Reset, i.e. stop, set time to zero and initialize all devices.
     */
    public void reset();

    /**
     * Sets the time position of this player.
     * 
    ...
    /**
     * Return the end of the last obejct to be played.
     * 
