...
**********************************************/
/*
 * File SimpleUserManager.java Created on 25.05.2004
 */
 ...
 */
public class PersistentUserManager extends SimpleUserManager implements MObject {

	static PersistenceManager pm = PersistenceFactory.getDefaultPersistenceManager();

	/**
	 * This is public only to allow persistence. TODO change to private, when persistence FW allows.
	 */
	public PersistentUserManager() {
	};

	private static PersistentUserManager instance; 
	
	/**
	 * @throws PersistenceException 
	 * 
	 */
	public static PersistentUserManager getInstance() throws PersistenceException {
		PersistentUserManager stored = (PersistentUserManager) pm.getByName("PersistentUserManager");
		if (stored != null) {
			instance = stored;
		} else {
			instance = new PersistentUserManager();
			pm.storeByName(instance, "PersistentUserManager");
		}
		return instance;
	}

	/**
	 * Saves the user data of this manager.
	 */
