 ...
 * @author tweyde
 */
public class ImageDisplay //extends AbstractSimpleEditor 
extends AbstractDisplay{
	...
	public void createGUI() {
	    ...
	    if(getEditObj() instanceof ImageURL){
	        imageUrl = (ImageURL)getEditObj();
	    } else {
	        imageUrl = (ImageURL)getPropertyValue();
	    }
		setLayout(new BorderLayout());
		imgComp =
			new ImageComponent(imageUrl.getSourceUrl());
		add(imgComp, BorderLayout.CENTER);
	}
