 ...
 * A MIDI multiplexer.
 *
 * A receiver that gets MidiEvents and sends them to a list of receivers. 
 * @author TW
 * @version 0.109
 */
public class MidiMultiplexer implements Receiver {
	private List<Receiver> outList = new ArrayList<Receiver>();
	...
	/**
	 * MidiMultiplexer constructor.
	 */
	public MidiMultiplexer() {
	 ...
	 * @param receivers 
	 */
	public MidiMultiplexer(Receiver ... receivers ) {
		for (int i = 0; i < receivers.length; i++) {
			outList.add(receivers[i]);
		}
	}
