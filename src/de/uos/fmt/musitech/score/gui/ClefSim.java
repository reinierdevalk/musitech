...
/** This class represents a column of 
 * @author Martin Gieseking
 * @version $Revision: 7766 $, $Date: 2010-03-10 18:53:18 +0100 (Wed, 10 Mar 2010) $ */
public class ClefSim implements SpringAttacher {
	private List<Clef> clefs = new ArrayList<Clef>();
	private int optimalSpace = 0;
	private int rwidth = 0;

	public void add(Clef clef) {
		clefs.add(clef);
		optimalSpace = Math.max(optimalSpace, clef.optimalSpace());
