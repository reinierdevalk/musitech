 ...
 *
 */
public class CustomAttachableScoreObject extends CustomScoreObject {
	...
	public CustomAttachableScoreObject(ScoreObject master, SVGSymbol sym, Attachable attachable) {
		super(master, null);
		this.sym = sym;
	...
	public void paint(Graphics g) {
		...
		int y = anker.absY() + (int)(attachable.getY() * ld);
		g.drawImage(rasteredImage, x, y, this);
	}
