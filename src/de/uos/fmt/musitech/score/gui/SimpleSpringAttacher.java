...
/** This class represents a simple invisible element that
 * can be installed in a spring system. It can be used to mark the beginning 
 * of a global system.
 * @author Martin Gieseking
 * @version $Revision: 7766 $, $Date: 2010-03-10 18:53:18 +0100 (Wed, 10 Mar 2010) $ */
public class SimpleSpringAttacher implements SpringAttacher {
	private int space;

	public SimpleSpringAttacher(int space) {
		this.space = space;
	}
