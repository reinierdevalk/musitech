...
public class TimeSignatureSim implements SpringAttacher
{
   private Vector timeSignatures = new Vector();
   ...
   public void add (TimeSignature timeSignature)
   {
 		...
 		optimalSpace = Math.max(optimalSpace, timeSignature.optimalSpace());
...
public void setXPos(int x)
   {
      ...
      {
         TimeSignature timeSignature = (TimeSignature)timeSignatures.get(i);
      	timeSignature.setXPos(x);
      }
   }
...
public void setParentXPos(int x)
   {
      ...
      {
         TimeSignature timeSignature = (TimeSignature) timeSignatures.get(i);
	      if (timeSignature.getScoreParent() != null)
      		timeSignature.getScoreParent().setXPos(x);
      }
   }
