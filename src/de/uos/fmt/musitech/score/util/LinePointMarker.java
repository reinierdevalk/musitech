...
public class LinePointMarker implements PointMarker
{
   private Graphics graphics;
   private Pair prevPoint;
   private boolean dotted;
   
   public LinePointMarker (Graphics graphics)
   {
...
public void markPoint(Pair p)
   {      
      ...
      int x2 = (int)Math.round(p.getX());
      int y2 = (int)Math.round(p.getY());
