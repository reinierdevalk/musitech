...
**********************************************/
package de.uos.fmt.musitech.scoreeditor.icons;
...
//	}
	...
	public static ImageIcon getIcon(String name,int size){
		Image i = Toolkit.getDefaultToolkit().createImage(Icons.class.getResource(name));
		return new ImageIcon(i.getScaledInstance(size, size, Image.SCALE_SMOOTH));
	}
}
