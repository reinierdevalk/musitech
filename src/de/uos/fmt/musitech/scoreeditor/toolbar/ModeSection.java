 ...
 * @version 30.08.2007
 */
public class ModeSection extends AbstractToolbarSection {

	private AbstractAction[] modus;

	public ModeSection(SectionController toolBarPanel) {
		super(toolBarPanel);
	}
	...
	protected void createItems() {
		...
		modus[0] = new AbstractAction(Messages.getString("ModeSection.ViewingMode"), Icons //$NON-NLS-1$
			...
			public void actionPerformed(ActionEvent e) {
				...
				modus[2].setEnabled(true);
				getScoreEditor().setModus(Mode.VIEW);
			}
		};
		...
		modus[1] = new AbstractAction(Messages.getString("ModeSection.SelectionMode"), Icons //$NON-NLS-1$
			...
			public void actionPerformed(ActionEvent e) {
				...
				modus[2].setEnabled(true);
				getScoreEditor().setModus(Mode.SELECT_AND_EDIT);
			}
		};
		...
		modus[2] = new AbstractAction(Messages.getString("ModeSection.InsertionMode"), Icons //$NON-NLS-1$
			...
			public void actionPerformed(ActionEvent e) {
				modus[0].setEnabled(true);
				modus[1].setEnabled(true);
				modus[2].setEnabled(false);
				getScoreEditor().setModus(Mode.INSERT);
			}
		};
	}
