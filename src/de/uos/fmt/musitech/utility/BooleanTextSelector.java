 ...
 * A class to implement a selector "debug/no debug" for the class dllPathConfigDialog
 * @date (08.07.01 18:03:00)
 * @author Alexander Luedeke
 * @version 0.113
 */
public class BooleanTextSelector extends javax.swing.JComboBox {
	...
	/**
	 * Returns true if the selected item equals "debug".
	 */
	public boolean getSelectedBoolean() {
		if ((getSelectedItem().toString()).equals("debug"))
			return true;
		else
			return false;
	}
