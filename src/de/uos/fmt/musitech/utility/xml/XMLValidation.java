...
class XMLValidation {
    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            System.out.println("Error : " + saxparseexception.getMessage() + " @ " + saxparseexception.getLineNumber()
                               + "," + saxparseexception.getColumnNumber() + " in " + saxparseexception.getSystemId());
        }
