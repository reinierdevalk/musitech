 ...
 * @author tweyde 
 */
public class MT_start {
	
	public void createTransportWindow(PlayTimer pTimer){
	...
	public void piecePlayback(){
		Piece p = new Piece();
		try {
			File f = new File("c:/data/maceo parker - House Party.mp3");
		...
		createTransportWindow(oPlayer.getPlayTimer());
		// TODO oPlayer.getPlayTimer().registerPlayer(your3DPlayer);
		
	}


	public static void main(String[] args) {
		new MT_start().piecePlayback();
	} // end main
