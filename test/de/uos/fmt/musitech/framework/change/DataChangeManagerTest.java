 ...
 */
public class DataChangeManagerTest extends TestCase {


	public static void main(String args[]){
		new DataChangeManagerTest().testChangeManager();
	}
	
	public void testChangeManager(){	
		IDataChangeManager cm = DataChangeManager.getInstance();
		
		DataChangeListener view = new PseudoListener();
		...
		for( int i=0; i<20; i++ ){
			...
			for (int j=0; j< 6; j++){
				Integer integer = new Integer(rand.nextInt(100));
				list.add(integer);
			}	
			cm.interestExpandElements(view, new ArrayList(list));			
		}
