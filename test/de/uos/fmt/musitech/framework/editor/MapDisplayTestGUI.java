...
/**
 * For testing the MapDisplay and its GUI.
 * 
 * @author Kerstin Neubarth
 *  
 */
public class MapDisplayTestGUI {
     ...
     *
     */
    public static class ObjForMapDisplay extends HashMap {
        public String name = "Name";

        public ObjForMapDisplay() {
            put("Syllable 1", createSyllable());
            put("Syllable 2", createSyllable());
            put("Lyrics 1", createLyrics());
            put("Chords 1", createChords());
            put("Chords 2", createChords());
        }
    ...
    /**
     * Sets up a MapDisplay for an ObjForMapDisplay.
     */
    public static void testGUI() {
        //create editObj
        ObjForMapDisplay editObj = new ObjForMapDisplay();
        //create MapDisplay
        Display display = null;
        try {
            display = EditorFactory.createDisplay(editObj, null, "Map", null);
