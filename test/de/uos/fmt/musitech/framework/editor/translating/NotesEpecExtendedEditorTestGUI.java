 ...
 *
 */
public class NotesEpecExtendedEditorTestGUI {
    ...
    private static void testWithGivenEpec(){
        ...
        NotesEpecExtendedEditor editor = new NotesEpecExtendedEditor();
    ...
    private static void testEpecWithClef(){
        String epec = "Cc 'c d e";     
        NoteList notes = new NoteList(epec);
        Display display = null;
        try {
            display = EditorFactory.createDisplay(notes, null, "Notation");
            JFrame frame = new JFrame("Test epec with clef");
    ...
    private static void testEpecWithClef2(){
        String epec = "Cc:-2 'c d e";   
        NoteList notes = new NoteList(epec);
        Display display = null;
        try {
            display = EditorFactory.createDisplay(notes, null, "Notation");
            JFrame frame = new JFrame("Test epec with clef -line");
            frame.getContentPane().add((JComponent)display);
            frame.pack();
            frame.setVisible(true);
        } catch (EditorConstructionException e) {
