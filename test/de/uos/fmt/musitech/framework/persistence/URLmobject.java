...
**********************************************/
/**
 * just an object to test persisting URLs and Files
 */
 ...
 */
public class URLmobject implements MObject {
    ...
    public URLmobject() {
        try {
            this.uuu = new URL("http://test.url");
            this.fff = new File("test.file");
    ...
    /**
     * @return Returns the fff.
     */
    public File getFff() {
        return fff;
    }
    /**
     * @param fff The fff to set.
     */
    public void setFff(File fff) {
        this.fff = fff;
    }
    /**
     * @return Returns the uuu.
     */
    public URL getUuu() {
        return uuu;
    }
