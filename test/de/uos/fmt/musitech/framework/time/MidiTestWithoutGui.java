 ...
 *  
 */
public class MidiTestWithoutGui {
...
//		}
		int i = 0;
		while (i < 5) {
			System.out.println("TEST: reset() " + i);
			objectPlayer.getPlayTimer().reset();
	...
	public Container makeContainer() {
		...
		for (int i = 0; i < 200; i++) {
			PerformanceNote perNote = new PerformanceNote(100000L * i, 50000);
			perNote.setPitch((i % 50) + 40);
			container.add(perNote);
			//			System.out.println("start: " + perNote.getTime()
			//			+ " length: "
			//			+ perNote.getDuration()
			//			+ " pitch: "
			//			+ perNote.getPitch());
	...
	public static void main(String[] args) {
		MidiTestWithoutGui test = new MidiTestWithoutGui();
