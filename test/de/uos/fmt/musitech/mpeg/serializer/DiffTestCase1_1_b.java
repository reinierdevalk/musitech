...
import de.uos.fmt.musitech.mpeg.testcases.TestCase1_1_b;
 ...
 */
public class DiffTestCase1_1_b extends MPEGDiffViewer {
    ...
    NotationVoice chorusVoice2(NotationSystem system, NotationStaff staff) {
        ...
        voice.addBeamContainer(new BeamContainer(context, getScoreNotes(notes, 0, 2)));
    ...
    public NotationSystem createNotationSystem() {
        //context.getPiece().getMetricalTimeLine().add(new
        // TimeSignatureMarker(3, 4, Rational.ZERO));
    ...
    public DiffTestCase1_1_b(String file) {
        super(file);
    }

    public static void main(String argv[]) {
        (new DiffTestCase1_1_b("/tmp/Diff1_1_b.xml")).setVisible(true);
