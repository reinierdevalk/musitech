 ...
 */
public class DiffTestCase2_6_a extends MPEGDiffViewer {
	...
	public NotationSystem createNotationSystem() {
        this.context=new TestCase2_6_a().context;
        return system;
        
    }

    public DiffTestCase2_6_a(String file) {
        super(file);
    }

    public static void main(String argv[]) {
        DiffTestCase2_6_a m = (new DiffTestCase2_6_a("tmp/Diff2_6_a.xml"));
        m.setVisible(true);
    }
