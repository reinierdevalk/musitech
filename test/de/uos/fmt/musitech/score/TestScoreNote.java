...
public class TestScoreNote extends TestCase {
	...
	public void testEquivalenceScoreNote(){
		System.out.println("testEquivalenceScoreNote");
	...
	public void testNonEquivalenceScoreNote(){
	...
	public static void main(String[] args) {
		TestScoreNote test = new TestScoreNote();
		test.testEquivalenceScoreNote();
	} 
