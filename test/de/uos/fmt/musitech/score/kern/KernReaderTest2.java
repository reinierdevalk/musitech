 ...
 */
public class KernReaderTest2 extends JFrame {
	 ...
	 */
	public KernReaderTest2(String filename) {
		super();
	...
	public static void main(String[] argv) {
	    ...
	    KernReaderTest2 kernReaderTest = null;
	    
		// Name of the file to import
		String filename = "import_Kern_4_1.krn";
		

		try {
		    // Create the KernReaderTest object and start the import
			kernReaderTest = 
			    new KernReaderTest2(filename);
