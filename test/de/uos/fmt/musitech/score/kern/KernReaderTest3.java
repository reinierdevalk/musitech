 ...
 */
public class KernReaderTest3 extends JFrame {
	 ...
	 */
	public KernReaderTest3(String filename) {
		super();
...
//		scorePanel.setSelectionClass("de.uos.fmt.musitech.gui.score.Clef");
	...
	public static void main(String[] argv) {
	    ...
	    KernReaderTest3 kernReaderTest = null;
	    
		// Name of the file to import
		String filename = "import_Kern_4_4.krn";

		try {
		    // Create the KernReaderTest object and start the import
			kernReaderTest = 
			    new KernReaderTest3(filename);
