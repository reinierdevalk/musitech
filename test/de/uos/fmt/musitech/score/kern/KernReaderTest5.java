 ...
 */
public class KernReaderTest5 extends JFrame {
	 ...
	 */
	public KernReaderTest5(String filename) {
		super();
	...
	public static void main(String[] argv) {
	    ...
	    KernReaderTest5 kernReaderTest = null;
	    
		// Name of the file to import
		String filename = "import_Kern_4_7.krn";

		try {
		    // Create the KernReaderTest object and start the import
			kernReaderTest = 
			    new KernReaderTest5(filename);
