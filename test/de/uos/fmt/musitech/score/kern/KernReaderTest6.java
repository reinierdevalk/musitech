 ...
 */
public class KernReaderTest6 extends JFrame {
	 ...
	 */
	public KernReaderTest6(String filename) {
		super();
	...
	public static void main(String[] argv) {
	    ...
	    KernReaderTest6 kernReaderTest = null;
	    
		// Name of the file to import
		String filename = "import_Kern_4_8.krn";

		try {
		    // Create the KernReaderTest object and start the import
			kernReaderTest = 
			    new KernReaderTest6(filename);
