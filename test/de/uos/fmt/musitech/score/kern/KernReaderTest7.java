 ...
 */
public class KernReaderTest7 extends JFrame {
	 ...
	 */
	public KernReaderTest7(String filename) {
		super();
	...
	public static void main(String[] argv) {
	    ...
	    KernReaderTest7 kernReaderTest = null;
	    
		// Name of the file to import
		String filename = "import_Kern_4_9.krn";

		try {
		    // Create the KernReaderTest object and start the import
			kernReaderTest = 
			    new KernReaderTest7(filename);
