 ...
 */
public class KernReaderTest8 extends JFrame {
	 ...
	 */
	public KernReaderTest8(String filename) {
		super();
	...
	class Action1 extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			if ((score.getActivePage() < score.numChildren() && direction == 1)
	...
	public static void main(String[] argv) {
	    ...
	    KernReaderTest8 kernReaderTest = null;
	    
		// Name of the file to import
		String filename = "musedata//corelli-op5n01//kern//op5n1-02.krn";
		...
		try {
		    ...
		    if (argv.length > 0) {
				...
				kernReaderTest = 
				    new KernReaderTest8(argv[0]);	       
		    } else {
			    // Create the KernReaderTest object and start the import
				kernReaderTest = 
				    new KernReaderTest8(filename);
		    }
