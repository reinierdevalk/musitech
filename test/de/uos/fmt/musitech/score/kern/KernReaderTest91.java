 ...
 */
public class KernReaderTest91 extends JFrame {
	 ...
	 */
	public KernReaderTest91(String filename) {
		super();
	...
	public static void main(String[] argv) {
	    ...
	    KernReaderTest91 kernReaderTest = null;
	    
		// Name of the file to import
		String filename = "import_Kern_4.krn";
		...
		try {
		    ...
		    if (argv.length > 0) {
				...
				kernReaderTest = 
				    new KernReaderTest91(argv[0]);	       
		    } else {
			    // Create the KernReaderTest object and start the import
				kernReaderTest = 
				    new KernReaderTest91(filename);
		    }
