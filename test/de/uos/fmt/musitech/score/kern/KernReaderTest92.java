 ...
 */
public class KernReaderTest92 extends JFrame {
	 ...
	 */
	public KernReaderTest92(String filename) {
		super();
	...
	public static void main(String[] argv) {
	    ...
	    KernReaderTest92 kernReaderTest = null;
	    
		// Name of the file to import
		String filename = "op5n1-1a.krn";
		...
		try {
		    ...
		    if (argv.length > 0) {
				...
				kernReaderTest = 
				    new KernReaderTest92(argv[0]);	       
		    } else {
			    // Create the KernReaderTest object and start the import
				kernReaderTest = 
				    new KernReaderTest92(filename);
		    }
