 ...
 */
public class KernReaderTestA extends JFrame {
	 ...
	 */
	public KernReaderTestA(String filename) {
		super();
	...
	public static void main(String[] argv) {
	    ...
	    KernReaderTestA kernReaderTest = null;
		...
		try {
		    ...
		    if (argv.length > 0) {
				...
				kernReaderTest = 
				    new KernReaderTestA(argv[0]);	       
		    } else {
			    // Create the KernReaderTest object and start the import
				kernReaderTest = 
				    new KernReaderTestA(filename);
		    }
