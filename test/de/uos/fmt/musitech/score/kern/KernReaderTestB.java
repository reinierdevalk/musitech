 ...
 */
public class KernReaderTestB extends JFrame {
	 ...
	 */
	public KernReaderTestB(String filename) {
		super();
	...
	public static void main(String[] argv) {
	    ...
	    KernReaderTestB kernReaderTest = null;
		...
		try {
		    ...
		    if (argv.length > 0) {
				...
				kernReaderTest = 
				    new KernReaderTestB(argv[0]);	       
		    } else {
			    // Create the KernReaderTest object and start the import
				kernReaderTest = 
				    new KernReaderTestB(filename);
		    }
