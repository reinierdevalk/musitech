 ...
 */
public class KernReaderTestC extends JFrame {
	 ...
	 */
	public KernReaderTestC(String filename) {
		super();
	...
	public static void main(String[] argv) {
	    ...
	    KernReaderTestC kernReaderTest = null;
	    
		// Name of the file to import
		String filename = "musedata/bach-1080/kern/1080-10.krn";
		...
		try {
		    ...
		    if (argv.length > 0) {
				...
				kernReaderTest = 
				    new KernReaderTestC(argv[0]);	       
		    } else {
			    // Create the KernReaderTest object and start the import
				kernReaderTest = 
				    new KernReaderTestC(filename);
		    }
