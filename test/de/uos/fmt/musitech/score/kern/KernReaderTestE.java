 ...
 */
public class KernReaderTestE extends JFrame {
	 ...
	 */
	public KernReaderTestE(String filename) {
		super();
	...
	public static void main(String[] argv) {
	    ...
	    KernReaderTestE kernReaderTest = null;
	    
		// Name of the file to import
//		String filename = "import_Kern_3.krn";
		String filename = "op103-02.krn";
		...
		try {
		    ...
		    if (argv.length > 0) {
				...
				kernReaderTest = 
				    new KernReaderTestE(argv[0]);	       
		    } else {
			    // Create the KernReaderTest object and start the import
				kernReaderTest = 
				    new KernReaderTestE(filename);
		    }
